  ...
  return (
    <main style={{maxWidth:920, margin:'0 auto', padding:'4rem 1rem'}}>
      ...
      <div className={styles.ctaGrid}>
        <a className={`button button--primary button--lg ${styles.ctaButton}`} href="https://btcnyc.github.io/classes/">📚 Classes & Guides</a>
        ...
        <a className={`button button--secondary button--lg ${styles.ctaButton}`} href="https://bitcoin-network-nyc.com/">💸 Donate (BTCPay)</a>
